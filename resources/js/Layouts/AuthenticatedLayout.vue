...
const servicesButtonClasses = computed(() => {
    return isServicesActive.value
                                    ...
                                    <Dropdown align="bottom" width="48">
                                        <template #trigger>
                                            <span class="inline-flex rounded-md">
                                                <button
                                                    type="button"
                                                    :class="servicesButtonClasses"
                                                >
                                                    Services

                                                    <svg
                                                        class="-me-0.5 ms-2 h-4 w-4 transition-transform duration-150 ease-in-out"
                                                        :class="{ 'rotate-180': isServicesActive }"
                    ...
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <div class="border-t border-gray-200 pb-1 pt-4">
                            ...
                            <div class="mt-1 space-y-1">
                                ...
                                <ResponsiveNavLink
                                    :href="route('ssl-certificates.index')"
                                    :active="route().current('ssl-certificates.*')"
                                >
                                    SSL Certificates
                                </ResponsiveNavLink>
                            </div>
